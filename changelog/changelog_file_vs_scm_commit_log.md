...
* `changelog.txt`:
  ...
  * `<dir>/**/<dir>/<file>`, `<dir>/**: <dir>/<file>`, `<dir>: **/<dir>/<file>`
  ...
  > [!NOTE]  
  > The <authors> list has meaning in the automation context where a changelog file lines rearranged and merged into another file using the repository commit authors to build the list.
